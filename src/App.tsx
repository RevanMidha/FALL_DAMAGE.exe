  ...
  return (
    <main className="relative h-screen w-screen overflow-hidden bg-[#080000] text-white">
      ...
      <motion.aside
        ...
        className="pointer-events-none absolute right-4 top-4 z-20 w-[min(360px,calc(100vw-2rem))] rounded-md border border-[#ff6d00]/25 bg-[rgba(8,0,0,0.84)] p-3 font-mono text-xs backdrop-blur-md"
      ...
      <aside className="pointer-events-none absolute left-4 top-24 bottom-24 z-20 hidden w-40 rounded-md border border-[#ff1744]/20 bg-[rgba(8,0,0,0.72)] p-3 font-mono text-[10px] text-white/55 backdrop-blur-md xl:block">
        <div className="mb-3 flex items-center justify-between">
          <span className="tracking-[0.3em] text-[#ff6d00]/80">TOWER</span>
          <span className="text-[#ffea00]">{ascentPercent}%</span>
        </div>
        <div className="relative h-full min-h-[340px] overflow-hidden rounded-sm border border-white/8 bg-[linear-gradient(180deg,rgba(255,23,68,0.08),rgba(0,0,0,0.18))]">
      ...
      <aside className="pointer-events-none absolute right-4 top-28 z-20 hidden w-[280px] rounded-md border border-[#ff1744]/20 bg-[rgba(8,0,0,0.78)] p-3 font-mono text-[10px] text-white/60 backdrop-blur-md md:block">
        <div className="mb-3 flex items-center justify-between">
      ...
      <AnimatePresence>
        {deaths > 0 && (
          <motion.div
            ...
            className="pointer-events-none absolute bottom-20 left-4 z-20 flex max-w-[min(540px,calc(100vw-2rem))] items-center gap-4 rounded-lg border-2 border-[#ff1744]/40 bg-[rgba(8,0,0,0.9)] px-5 py-3 font-mono backdrop-blur-md"
